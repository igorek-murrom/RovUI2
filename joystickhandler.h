...
/*!
 * \brief The JoystickHandler class is used to parse input from the connected joystick(-s)
 */
...
public slots:
    ...
    /*!
     * \brief Called to update everything about a connected joystick, including settings
     */
    void updateJoystick();
...
private:
    /*!
     * \brief Maps value x from range defined by in_min and in_max to range defined by out_min and out_max
     * \param x
     * \param in_min
     * \param in_max
     * \param out_min
    ...
    /*!
     * \brief Mutex which is used to prevent data race conditions related to m_joystick
     */
